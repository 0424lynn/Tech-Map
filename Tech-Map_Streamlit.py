...
with st.sidebar:
    ...
    only_show_good_points = st.checkbox("Show only good techs", value=False)
...
# Cluster mode with colored bubbles by Level
if use_cluster:
    clusters = {}
    ...
    for _, row in points.iterrows():
        ...
        larger = _is_inhouse(row.get('Name',''))  # INHOUSE uses larger pin
...
">
  <div style="font-weight:600; margin-bottom:4px;">Level colors</div>
